...
public class EcritureComptable {
	...
	/** The Reference. */
	@Pattern(regexp = "\\w{1,5}-\\d{4}/\\d{5}", message = "format de la reference incorect: LL-DDDD/NNNNN")
	...
	public boolean isEquilibree() {
		...
		boolean vRetour = this.getTotalDebit().compareTo(getTotalCredit()) == 0 ? true : false;
